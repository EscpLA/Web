<template>
  <div class="contentSeventhBtm">
      <div class="contentSeventhBtmLeft">
      ...
      <div class="contentSeventhBtmRight">
            <h320px24292e msg="Hosted where you need it"/>
            <p14px586069 msg="Securely and reliably host your work on GitHub using GitHub Enterprise Cloud. Or deploy GitHub Enterprise Server in your own data centers or in a private cloud using Amazon Web Services, Azure, or Google Cloud Platform."/>
            <a16px0366d6 msg="Compare plans →"/>
            <a16px0366d6 msg="Contact Sales for more information →"/>
      </div>
  </div>
</template>

<script>
import h320px24292e from '../TEXT/h320px24292e'
import p14px586069 from '../TEXT/p14px586069'
import a16px0366d6 from '../TEXT/a16px0366d6'
export default {
    name:"contentSeventhBtm",
    components:{
        h320px24292e,
        p14px586069,
        a16px0366d6,
...
<style>
    ...
    .contentSeventhBtmLeft{}
    .contentSeventhBtmRight{}
