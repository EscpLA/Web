<template>
  <div class="footerBottom">
      <div class="footerBottomContent">
            <div class="footerBottomContentLeft">
                <div class="footerBottomContentLeftpDiv">
                    <p class="footerBottomContentLeftp">© 2020 GitHub, Inc.</p>
                </div>
                <div class="footerBottomContentLeftUl">
                    <ul>
                        <a href="">
                        <li v-for="(item,index) in footerBottomarr" :key="index">
                            {{item}}
                        </li>
                        </a>
                    </ul>
            ...
            <div class="footerBottomContentRight">
...
export default {
    ...
    data:function(){
        return{
            footerBottomarr:["Terms","Privacy","Site Map","What is Git?"]
        }
    }
}
</script>
...
<style>
    ...
    .footerBottomContentLeftp{
        font-size: 12px;
        color: #586069;
        margin-top: 4px;
        margin-left: 10px;
    }
    .footerBottomContentLeftUl a{
        font-size: 12px;
        color: #586069;
    }
    .footerBottomContentLeftUl li{
